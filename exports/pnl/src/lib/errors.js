...
// can act on, rather than leaking a raw driver message into the UI.

const MIGRATION_HINT = 'Run schema.sql and reload.'
...
const CONSTRAINT_MESSAGES = [
  ['expenses_amount_check', 'An expense cannot be zero.'],
  ['expenses_category_check', 'Pick a category for the expense.'],
  ['sales_amount_check', 'A sale amount cannot be negative.'],
  ['sales_cost_check', 'A sale cost cannot be negative.'],
]
